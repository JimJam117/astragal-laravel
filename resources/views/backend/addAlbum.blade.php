...
<form action="/backend/album" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row mb-0">
        <button class="btn btn-primary text-center align-items-center" type="submit" name="button">Add New Album</button>
    </div>
</form>
<hr>
